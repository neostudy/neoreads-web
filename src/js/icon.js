...
import { faUser, faSearch, faList, faStream, faVolumeUp, faHeart, faQuoteLeft, faComments, faPenSquare, faPen, faGlobeAsia, faQuestion, faBookReader, faPenAlt, faTrash, faSort, faPlay, faNewspaper, faBook, faEdit, faHandsHelping } from '@fortawesome/free-solid-svg-icons'
...
library.add(faPenAlt, faTrash, faSort)
